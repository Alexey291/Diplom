...
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (5, true, 1, 'New post1','text1', '2020.10.23 17:08:11', 3, 565);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (6, true, 1, 'New post2','text2', '2020.10.22 14:08:11', 3, 452);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (7, true, 1, 'New post3','text3', '2020.10.18 14:08:11', 4, 812);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (8, true, 1, 'New post4','text4', '2020.10.17 14:56:11', 4, 754);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (9, true, 1, 'New post5','text5', '2020.10.16 14:56:11', 5, 759);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (10, true, 1, 'New post6','text6', '2020.10.21 12:53:05', 6, 832);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (11, true, 1, 'New post7','text7', '2020.10.24 12:48:02', 7, 531);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (12, true, 1, 'New post8','text8', '2020.10.24 14:28:15', 7, 712);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (13, true, 1, 'New post9','text9', '2020.10.12 13:56:15', 5, 513);
insert into posts (id, is_active, moderation_status, title, text, time_post, user_id, view_count)
    values (14, true, 1, 'New post10','text10', '2020.10.13 12:58:13', 6, 256);
